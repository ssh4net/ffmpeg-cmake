...
function(ffmpeg_native_autoconfig)
    ...
    if(FFMPEG_BUILD_PROGRAMS)
        ...
        set(_ffmpeg_build_ffplay OFF)
        if(FFMPEG_NATIVE_BUILD_FFPLAY STREQUAL "ON")
            set(_ffmpeg_build_ffplay ON)
        elseif(FFMPEG_NATIVE_BUILD_FFPLAY STREQUAL "AUTO")
            _ffmpeg_native_dep_create_sdl2_target(_ffmpeg_sdl2_target _ffmpeg_sdl2_found)
            if(_ffmpeg_sdl2_found)
                set(_ffmpeg_build_ffplay ON)
            endif()
        endif()
        if(_ffmpeg_build_ffplay)
