...
function(_ffmpeg_native_objects_to_sources _out _base_dir)
    ...
    foreach(_ffmpeg_object IN LISTS ARGN)
        ...
        set(_ffmpeg_cxx_source "${_base_dir}/${_ffmpeg_stem}.cpp")
        set(_ffmpeg_objc_source "${_base_dir}/${_ffmpeg_stem}.m")
        set(_ffmpeg_asm_source "${_base_dir}/${_ffmpeg_stem}.asm")

        if(EXISTS "${_ffmpeg_c_source}")
            list(APPEND _ffmpeg_sources "${_ffmpeg_c_source}")
        elseif(EXISTS "${_ffmpeg_cxx_source}")
            list(APPEND _ffmpeg_sources "${_ffmpeg_cxx_source}")
        elseif(EXISTS "${_ffmpeg_objc_source}")
            list(APPEND _ffmpeg_sources "${_ffmpeg_objc_source}")
...
function(_ffmpeg_native_write_disabled_branch_stubs _out _library)
    if(_library STREQUAL "avcodec")
        set(_ffmpeg_stub "${FFMPEG_NATIVE_GENERATED_DIR}/libavcodec/disabled_branch_stubs.c")
        file(MAKE_DIRECTORY "${FFMPEG_NATIVE_GENERATED_DIR}/libavcodec")
        set(_ffmpeg_content "/* Generated by ffmpeg-cmake native backend. */\n#include <stdint.h>\n#include \"config.h\"\n#include \"config_components.h\"\n#include \"libavcodec/h261.h\"\n#include \"libavcodec/jpeglsdec.h\"\n#include \"libavcodec/rv10dec.h\"\n#include \"libavcodec/wmv2dec.h\"\n\n#if !CONFIG_JPEGLS_DECODER\nint ff_jpegls_decode_picture(MJpegDecodeContext *s)\n{\n    (void)s;\n    return -1;\n}\n#endif\n\n#if !CONFIG_WMV2_DECODER\nvoid ff_wmv2_add_mb(MpegEncContext *s, int16_t block[6][64],\n                    uint8_t *dest_y, uint8_t *dest_cb, uint8_t *dest_cr)\n{\n    (void)s;\n    (void)block;\n    (void)dest_y;\n    (void)dest_cb;\n    (void)dest_cr;\n}\n#endif\n\n#if !CONFIG_RV10_DECODER\nint ff_rv_decode_dc(struct H263DecContext *const h, int n)\n{\n    (void)h;\n    (void)n;\n    return -1;\n}\n#endif\n\n#if !CONFIG_H261_DECODER && !CONFIG_H261_ENCODER\nvoid ff_h261_loop_filter(struct MpegEncContext *s)\n{\n    (void)s;\n}\n#endif\n")
        _ffmpeg_native_write_file_if_changed("${_ffmpeg_stub}" "${_ffmpeg_content}")
        set(${_out} "${_ffmpeg_stub}" PARENT_SCOPE)
    elseif(_library STREQUAL "avformat")
        set(_ffmpeg_stub "${FFMPEG_NATIVE_GENERATED_DIR}/libavformat/disabled_branch_stubs.c")
        file(MAKE_DIRECTORY "${FFMPEG_NATIVE_GENERATED_DIR}/libavformat")
        set(_ffmpeg_content "/* Generated by ffmpeg-cmake native backend. */\n#include <stdint.h>\n#include \"config.h\"\n#include \"config_components.h\"\n#include \"libavformat/dv.h\"\n#include \"libavformat/spdif.h\"\n#include \"libavformat/w64.h\"\n\n#if !CONFIG_DV_DEMUXER\nvoid ff_dv_ts_reset(DVDemuxContext *c, int64_t ts_video)\n{\n    (void)c;\n    (void)ts_video;\n}\n#endif\n\n#if !CONFIG_SPDIF_DEMUXER\nint ff_spdif_probe(const uint8_t *p_buf, int buf_size, enum AVCodecID *codec)\n{\n    (void)p_buf;\n    (void)buf_size;\n    if (codec)\n        *codec = AV_CODEC_ID_NONE;\n    return 0;\n}\n\nint ff_spdif_read_packet(AVFormatContext *s, AVPacket *pkt)\n{\n    (void)s;\n    (void)pkt;\n    return -1;\n}\n#endif\n\n#if !CONFIG_W64_DEMUXER && !CONFIG_W64_MUXER\nconst uint8_t ff_w64_guid_data[16] = { 0 };\n#endif\n")
        _ffmpeg_native_write_file_if_changed("${_ffmpeg_stub}" "${_ffmpeg_content}")
        set(${_out} "${_ffmpeg_stub}" PARENT_SCOPE)
    else()
...
function(_ffmpeg_native_collect_makefile_objects _out _library)
    ...
    _ffmpeg_native_write_disabled_branch_stubs(_ffmpeg_disabled_branch_stubs "${_library}")
    list(APPEND _ffmpeg_sources ${_ffmpeg_disabled_branch_stubs})
    if(_library STREQUAL "avutil" AND FFMPEG_NATIVE_EFFECTIVE_ENABLE_ASM AND NOT FFMPEG_NATIVE_EFFECTIVE_ENABLE_X86_TX_ASM)
