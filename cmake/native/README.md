...
- `FFmpegNativeSmokeTests.cmake`: adds query-only and hardware CTest smoke tests.
- `FFmpegNativeConsumerTests.cmake`: installs the native package and validates exported targets with a separate CMake consumer.
